...
// Source: github.com/vihuvac/simple-bank/src/database/sqlc (interfaces: Store)
...
import (
	...
	database "github.com/vihuvac/simple-bank/src/database/sqlc"
)
...
func (m *MockStore) GetSessionById(arg0 context.Context, arg1 uuid.UUID) (database.Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateTransfer(arg0 context.Context, arg1 database.UpdateTransferParams) (database.Transfer, error) {
	m.ctrl.T.Helper()
